...
## 16. <span style="color:red">Put the current computer time in milliseconds into a variable</span>

## 17. <span style="color:red">Measure how long a piece of code takes to run by measuring the time before the code is run, and after the code is run, and taking the difference to find the total time</span>

## 18. <span style="color:red">Read a .txt file or .csv file into a variable</span>
...
## 20. <span style="color:red">Create a variable that stores a 20x20 matrix of random numbers</span>

## 21. <span style="color:red">Output any matrix to a txt file using commas or tabs to separate column values, and new lines to separate row values</span>

# Hard Problems

## <span style="color:red">1. The FizzBuzz Problem</span>
...
## <span style="color:red">2. Frequeny Counts</span>
...
## <span style="color:red">3. Test the Random Number Generator</span>
...
## <span style="color:red">4. Create a Multiplication Table</span>
...
## <span style="color:red">5. Encrypt and Decrypt the Alphabet</span>
...
## <span style="color:red">7. Dice Rolling Simulations</span>
...
## <span style="color:red">8. Monte Hall Problem</span>
